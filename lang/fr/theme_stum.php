...
$string['favicon_desc'] = 'Modifiez le favicon de stum. Les images avec un fond transparent et une hauteur de 32 pixels fonctionneront mieux. Types autorisés: PNG, JPG, ICO';
...
$string['block_icons'] = 'Icônes des blocs du thème stum';
...
$string['use_fa5_desc'] = 'Utiliser les nouvelles icônes web Font Awesome 5.<br /><strong>Note :</strong> Font Awesome version 5 a été complètement récrit et redessiné. Vous devez donc effectuer un certain nombre d\'opérations si vous avez déjà utilisé Font Awesome par le passé avec le thème stum. Il nécessaire de rechercher tous les noms des icônes de la version 4 qui ont un nom différent dans la version 5 et les remplacer par ces derniers. Veuillez svp vous référer au document <a href="https://fontawesome.com/how-to-use/upgrading-from-4#icon-name-changes" target="_blank">liste des icônes dont le nom a changé</a>.<br />Si c\'est la première fois que vous mettez le thème stum en service, il est recommandé d\'utiliser directement la version 5 des icônes de Font Awesome.';
