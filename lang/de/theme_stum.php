...
/* Core */
$string['configtitle'] = 'stum';
$string['pluginname'] = 'stum';
$string['choosereadme'] = '
<div class="clearfix">
<div style="margin-bottom:20px;">
<p style="text-align:center;"><img class="img-polaroid" src="stum/pix/screenshot.jpg" /></p>
</div>
<hr />
<h2>stum - Responsive Moodle Theme</h2>
...
<hr />
<p style="text-align:center;"><img class="img-polaroid" src="stum/pix/redPIthemes.jpg" /></p>';
...
$string['favicon_desc'] = 'Ändern Sie das Favicon für stum. Bilder mit einem transparenten Hintergrund und 32px Höhe funktionieren am besten. Erlaubte Typen: PNG, JPG, ICO';
...
$string['block_icons'] = 'Theme stum Blocksymbole';
...
$string['use_fa5_desc'] = 'Verwenden Sie die neuen Font Awesome 5 Web Font Icons.<br /><strong>Bitte beachten Sie:</strong> Font Awesome Version 5 wurde komplett neu geschrieben und von Grund auf neu gestaltet. Es sind also einige Schritte notwendig, wenn Sie die Symbole bereits mit einer früheren Version von Theme stum verwendet haben. Es wird notwendig sein, alle Icons, die zwischen Version 4 und 5 unterschiedliche Namen haben, zu finden und zu ersetzen. Stellen Sie sicher, dass Sie diese <a href="https://fontawesome.com/how-to-use/upgrading-from-4#icon-name-changes" target="_blank">Liste mit Namensänderungen </a>.<br /> Wenn Sie stum zum ersten Mal auf Ihrer Moodle-Seite installieren, wird die neue Version 5 empfohlen.';
