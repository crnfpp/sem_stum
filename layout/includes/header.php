...
$searchbox = theme_stum_get_setting('navbar_search_form');
$login_link = theme_stum_get_setting('login_link');
$login_custom_url = theme_stum_get_setting('custom_login_link_url');
$login_custom_txt = theme_stum_get_setting('custom_login_link_txt');
$home_button = theme_stum_get_setting('home_button');
$shadow_effect = theme_stum_get_setting('shadow_effect');
$auth_googleoauth2 = theme_stum_get_setting('auth_googleoauth2');
...
<header class="navbar">
    <nav class="navbar-inner">
        <div class="stum-custom-menu container-fluid">
            <?php
            ...
            <div class="nav-collapse collapse">
                ...
                <form id="search" action="<?php if ($moodle_global_search) {echo $CFG->wwwroot.'/search/index.php';} else {echo $CFG->wwwroot.'/course/search.php';} ?>" >
                	<label for="coursesearchbox" class="stum-sr-only"><?php if ($moodle_global_search) {echo get_string('search', 'search');} else {echo get_string('searchcourses');} ?></label>						
					...
					<button type="submit"><span class="stum-sr-only"><?php echo get_string('submit'); ?></span></button>						
				</form>
                <?php } ?>
...
<?php if ($shadow_effect) { ?>
	<div class="container-fluid" style="background: #fff;"><img src="<?php echo $OUTPUT->image_url('bg/stum-shadow', 'theme'); ?>" class="stum-shadow" alt=""></div>
<?php } ?>