...
$hide_breadrumb_setting = theme_stum_get_setting('hide_breadcrumb');
    ...
    <div id="page-content" class="row-fluid">
        <div id="<?php echo $regionbsid ?>" class="span9">
            <div class="row-fluid">
                ...
                <?php } ?>
                    <?php
					if (strpos($body_attributes, 'page-contentbank') !== false) {echo $OUTPUT->stum_h5p_header();}
