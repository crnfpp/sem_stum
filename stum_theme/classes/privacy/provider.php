...
class provider implements
    ...
    const SITEBAR_STAT = 'theme_stum_sidebar';
    ...
    public static function export_user_preferences(int $userid) {
        ...
        if (isset($draweropennavpref)) {
            $preferencestring = get_string('privacy_sidebar_closed', 'theme_stum');
            if ($draweropennavpref == 'true') {
                $preferencestring = get_string('privacy_sidebar_open', 'theme_stum');
            }
