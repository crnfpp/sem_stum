 ...
 *
 */
function theme_stum_get_setting($setting, $format = false) {
    global $CFG;
    require_once($CFG->dirroot . '/lib/weblib.php');
    static $theme;
    if (empty($theme)) {
        $theme = theme_config::load('stum');
    }
...
function theme_stum_pluginfile($course, $cm, $context, $filearea, $args, $forcedownload, array $options = array()) {
...
function theme_stum_page_init(moodle_page $page)
{
    $page->requires->jquery();
	if ($page->pagelayout === 'frontpage') {
        $page->requires->jquery_plugin('jquery.easing.min.1.4', 'theme_stum');
        $page->requires->jquery_plugin('slideshow', 'theme_stum');
        $page->requires->jquery_plugin('carousel', 'theme_stum');
    }
}

function stum_set_pagewidth1($css, $pagewidth) {
...
function stum_set_category_layout($css,$category_layout) {
	global $CFG;
...
function stum_set_logo_res($css, $logo_res) {
...
function stum_set_block_icons($css, $block_icons) {
...
function stum_hide_category_background($css, $hide_category_background) {
...
function stum_set_customcss($css, $customcss) {
...
function theme_stum_process_css($css, $theme) {
	global $CFG;
	
    $pagewidth = $theme->settings->pagewidth;
    $css = stum_set_pagewidth1($css,$pagewidth);
	$css = stum_set_pagewidth2($css,$pagewidth);
	$logo_res = $theme->settings->logo_res;
	$css = stum_set_logo_res($css,$logo_res);
	$category_layout = $theme->settings->category_layout;
	$css = stum_set_category_layout($css,$category_layout);
	$block_icons = $theme->settings->block_icons;
	$css = stum_set_block_icons($css,$block_icons);
	$hide_category_background = $theme->settings->hide_category_background;
	$css = stum_hide_category_background($css,$hide_category_background);
	$socials_header_bg = $theme->settings->socials_header_bg;
	$css = theme_stum_set_border_top($css,$socials_header_bg);
    ...
    $css = theme_stum_set_customfontface($css, $font_heading_src, $font_body_src);
    $css = theme_stum_set_headingfont($css, $headingfont, $headingweight);
    $css = theme_stum_set_bodyfont($css, $bodyfont, $bodysize);
    ...
    $css = stum_set_customcss($css, $customcss);
    ...
    $css = theme_stum_set_category_banner_font_color($css, $banner_font_color);
    ...
    $css = theme_stum_set_socials_header_bg($css, $socials_header_bg);
    ...
    $css = theme_stum_set_maincolor($css, $maincolor);
    ...
    $css = theme_stum_set_mainhovercolor($css, $mainhovercolor);
    ...
    $css = theme_stum_set_linkcolor($css, $linkcolor);
    ...
    $css = theme_stum_set_def_buttoncolor($css, $def_buttoncolor);
    ...
    $css = theme_stum_set_def_buttonhovercolor($css, $def_buttonhovercolor);
    ...
    $css = theme_stum_set_headercolor($css, $headercolor);
    ...
    $css = theme_stum_set_menufirstlevelcolor($css, $menufirstlevelcolor);
    ...
    $css = theme_stum_set_menufirstlevel_linkcolor($css, $menufirstlevel_linkcolor);
    ...
    $css = theme_stum_set_menusecondlevelcolor($css, $menusecondlevelcolor);
    ...
    $css = theme_stum_set_menusecondlevel_linkcolor($css, $menusecondlevel_linkcolor);
    ...
    $css = theme_stum_set_footercolor($css, $footercolor);
    ...
    $css = theme_stum_set_footerheadingcolor($css, $footerheadingcolor);
    ...
    $css = theme_stum_set_footertextcolor($css, $footertextcolor);
    ...
    $css = theme_stum_set_copyrightcolor($css, $copyrightcolor);
	...
	$css = theme_stum_set_copyright_textcolor($css, $copyright_textcolor);
    ...
    $css = theme_stum_set_socials_color($css, $socials_color);
    ...
    $css = theme_stum_set_carousel_img_dim($css, $carousel_img_dim);
    ...
    $css = theme_stum_set_slideshow_height($css, $slideshow_height, $hide_captions);
	...
	$css = theme_stum_set_category_banner_bg($css, $background);
	...
	$css = theme_stum_set_header_bg($css, $background, $repeat);
	...
	if (is_null($theme->setting_file_url('pagebackground', 'pagebackground'))) {
		...
		if ($theme->settings->list_bg==0)  {
			...
			$repeat = 'no-repeat fixed 0 0';
			$size = 'cover';}
		$css = theme_stum_set_pagebackground($css, $pagebackground, $setting);
		$css = theme_stum_set_background_repeat($css, $repeat, $size);
    } else {
	...
	if (!empty($CFG->themedir)) {
		$cssstum = file_get_contents($CFG->themedir . '/stum/bootstrapbase/moodle.css');
		}
	else {
		$cssstum = file_get_contents($CFG->dirroot . '/theme/stum/bootstrapbase/moodle.css');
	}
	$cssstum .= "\n" . $css;
...
function theme_stum_set_customfontface($css, $font_heading_src, $font_body_src) {
...
function theme_stum_set_headingfont($css, $headingfont, $headingweight) {
...
function theme_stum_set_bodyfont($css, $bodyfont, $bodysize) {
...
function theme_stum_set_maincolor($css, $themecolor) {
...
function theme_stum_set_mainhovercolor($css, $themecolor) {
...
function theme_stum_set_linkcolor($css, $themecolor) {
...
function theme_stum_set_def_buttoncolor($css, $themecolor) {
...
function theme_stum_set_def_buttonhovercolor($css, $themecolor) {
...
function theme_stum_set_headercolor($css, $themecolor) {
...
function theme_stum_set_menufirstlevelcolor($css, $themecolor) {
...
function theme_stum_set_menufirstlevel_linkcolor($css, $themecolor) {
...
function theme_stum_set_menusecondlevelcolor($css, $themecolor) {
...
function theme_stum_set_menusecondlevel_linkcolor($css, $themecolor) {
...
function theme_stum_set_footercolor($css, $themecolor) {
...
function theme_stum_set_footerheadingcolor($css, $themecolor) {
...
function theme_stum_set_footertextcolor($css, $themecolor) {
...
function theme_stum_set_copyrightcolor($css, $themecolor) {
...
function theme_stum_set_copyright_textcolor($css, $themecolor) {
...
function theme_stum_set_socials_color($css, $themecolor) {
...
function theme_stum_set_socials_header_bg($css, $themecolor) {
...
function theme_stum_set_carousel_img_dim($css, $carousel_img_dim) {
...
function theme_stum_set_slideshow_height($css, $slideshow_height, $hide_captions) {
...
function theme_stum_set_category_banner_font_color($css, $themecolor) {
...
function theme_stum_set_category_banner_bg($css, $background) {
    global $OUTPUT;
...
function theme_stum_set_header_bg($css, $background, $repeat) {
    global $OUTPUT;
...
function theme_stum_set_pagebackground($css, $pagebackground, $setting) {
    global $OUTPUT;
...
function theme_stum_set_background_repeat($css, $repeat, $size) {
...
function theme_stum_set_border_top($css,$socials_header_bg) {
...
function theme_stum_init_sidebar(moodle_page $page) {
    user_preference_allow_ajax_update('theme_stum_sidebar', PARAM_TEXT);
    $page->requires->yui_module('moodle-theme_stum-sidebar', 'M.theme_stum.sidebar.init', array());
}

function theme_stum_get_sidebar_stat() {
    return get_user_preferences('theme_stum_sidebar', '');
}

function theme_stum_is_jpeg(&$pict) {
    return (bin2hex($pict[0]) == 'ff' && bin2hex($pict[1]) == 'd8');
}

function theme_stum_is_png(&$pict) {
    return (bin2hex($pict[0]) == '89' && $pict[1] == 'P' && $pict[2] == 'N' && $pict[3] == 'G');
}

function theme_stum_getslidesize($img_loc) {
	if (theme_stum_is_jpeg($img_loc)) {
    ...
    return FALSE;
	} else if (theme_stum_is_png($img_loc)) {
		$handle = fopen( $img_loc, "rb" );
    	if ( ! feof( $handle ) ) {
